...
function Diretor(nome) {
    ...
    this.aumento = function() {
        const novoSalario = this.getSalario() * 2.5;
        this.setSalario(novoSalario);
    }
}

const funcionario1 = new Funcionario("Talita", "dev front-end", 5000);
const funcionario2 = new Estagiario("Rico");
const funcionario3 = new Diretor("Edilson Bispo");
